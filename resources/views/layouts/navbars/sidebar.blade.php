<div class="sidebar" data-color="orange" data-background-color="white" data-image="{{ asset('material') }}/img/sidebar-1.jpg">
  ...
  -->
  <div class="logo">
    <div class="simple-text logo-normal"> {{ __('sidebar.name') }}</div>
  </div>
  <div class="sidebar-wrapper">
    <ul class="nav">
      <li class="nav-item{{ $activePage == 'dashboard' ? ' active' : '' }}">
        <a class="nav-link" href="{{ route('home') }}">
          <svg xmlns="http://www.w3.org/2000/svg" width="45" height="25" fill="currentColor" class="bi bi-house-door" viewBox="0 0 16 16">
      ...
      <li class="nav-item{{ $activePage == 'search' ? ' active' : '' }}">
        <a class="nav-link" href="{{ route('search') }}">
          <!-- <i class="material-icons">library_books</i> -->
          <!-- <i class="material-icons">content_paste</i> -->
          <svg xmlns="http://www.w3.org/2000/svg" width="45" height="20" fill="currentColor" class="bi bi-columns-gap" viewBox="0 0 16 16">
      ...
      <li class="nav-item{{ $activePage == 'building' ? ' active' : '' }}">
        <a class="nav-link" href="{{ route('building') }}">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="45" height="25" fill="currentColor" class="bi bi-building" viewBox="0 0 16 16">
      ...
      <li class="nav-item{{ $activePage == 'responsibilities' ? ' active' : '' }}">
        <a class="nav-link" href="{{ route('responsibilities') }}">
          <!-- <i class="material-icons">notifications</i> -->
          <svg xmlns="http://www.w3.org/2000/svg" width="45" height="25" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z" />
          </svg>
          <span class="bi bi-pencil-square">{{ __('sidebar.responsibilities') }}</p>
        </a>
      </li>
      @endcan
